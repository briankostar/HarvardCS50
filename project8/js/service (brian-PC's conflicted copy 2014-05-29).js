...
function dropoff()
{
    //remove person from bus, reset their location?
    alert("TODO");
}
...
{
    alert("TODO");
    //if button clicked when shuttle is within 15.0m of passenger and seat is empty, 
    //give seat, remove from 2d and 3d map.
    //if multi within 15m, pick up as much as possible
    
    //if > 15, anounce that you're still far
    
    //if within 15, but no seat, say it. anouncement cleared when shuttle moves again.
    
    //var d = shuttle.distance(lat, lng); <-shuttle d from lat/lng
    
    //removeplacemark from 3d
    //var features = earth.getFeatures();
    //features.removeChild(p);
    
    //m.setMap(null); <-remove marker from 2d
    
    //fix populate - remember placemarks/markers. global array/objects
    
    //giving seat - fix shuttle.seats. call #seats w chart. fix chart
